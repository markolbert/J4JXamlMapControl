...
public class GroundOverlay : MapPanel
{
    ...
    private async Task<IEnumerable<ImageOverlay>> ReadGroundOverlaysFromArchiveAsync(string archiveFilePath)
    {
        ...
        foreach (var imageOverlay in imageOverlays)
        {
            ...
            await using var zipStream = imageEntry.Open();
    ...
    private async Task<IEnumerable<ImageOverlay>> ReadGroundOverlaysFromFileAsync(string docFilePath)
    {
